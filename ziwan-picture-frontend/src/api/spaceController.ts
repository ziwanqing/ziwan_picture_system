...
/** getUserSpaceId POST /api/space/get/user/spaceId */
export async function getUserSpaceIdUsingPost(options?: { [key: string]: any }) {
  return request<API.BaseResponseLong_>('/api/space/get/user/spaceId', {
    method: 'POST',
    ...(options || {}),
  })
}
