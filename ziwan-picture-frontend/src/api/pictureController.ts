...
/** batchEditPictureMetadata POST /api/picture/batch/edit */
export async function batchEditPictureMetadataUsingPost(
  body: API.PictureEditByBatchRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseBoolean_>('/api/picture/batch/edit', {
    method: 'POST',
    headers: {
...
/** uploadPictureByBatch POST /api/picture/load/batch */
export async function uploadPictureByBatchUsingPost(
  body: API.PictureUploadByBatchRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseInt_>('/api/picture/load/batch', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
